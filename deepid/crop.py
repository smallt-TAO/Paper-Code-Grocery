...
def crop_img_by_half_center(src_file_path, dest_file_path):
    ...
    start_point_xy = int(x_size / 4)
    end_point_xy   = int(x_size / 4 + x_size / 2)
    box = (start_point_xy, start_point_xy, end_point_xy, end_point_xy)
    #  new_im = im.crop(box)
    new_im = im
    new_new_im = new_im.resize((int(80), int(80)))
...
if __name__ == '__main__':
    aligned_db_folder = "data/bookimg_320_100"
    result_folder = "data/crop_images_DB_1"
