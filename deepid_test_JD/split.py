...
def fatch_pics_for_one_user(people_path):
    ...
    #        for video_file_name in os.listdir(people_path +'/'+ video_folder):
    #            people_imgs.append(os.path.join(people_path, video_folder, video_file_name))
    for video_file_name in os.listdir(people_path):
        people_imgs.append(os.path.join(people_path, video_file_name))
...
if __name__ == '__main__':
    random.seed(7)
    src_folder     = "data/crop_images_DB_1"
