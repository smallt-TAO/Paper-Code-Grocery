...
k = 1             # # of discrimination updates for each gen update
...
ndfc = 1024       # # of discrimination units for fully connected layers
ngf = 64          # # of gen filters in first conv layer
ndf = 64          # # of discrimination filters in first conv layer
