...
class Model(object):
  ...
  def pool_views_fn(self, nets):
    ...
    with tf.variable_scope('pool_views_fn/STCK'):
      ...
      reshape = tf.reshape(net, [batch_size, -1, feature_size])
      return reshape
  ...
  def create_base(self,
    ...
    with tf.variable_scope(scope, reuse=reuse):
      ...
      print('--------------net,labels_one_hot')
      print(net.get_shape())
      print(labels_one_hot.get_shape())
  ...
  def create_loss(self, labels, endpoints):
    ...
    print(endpoints.chars_logit.get_shape())
    print(labels.get_shape())
    self.sequence_loss_fn(endpoints.chars_logit, labels)
